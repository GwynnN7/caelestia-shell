...
BusyIndicator {
    ...
    property real strokeWidth: Tokens.padding.large
    ...
    component Updater: QtObject {
        readonly property int duration: 5400 * Tokens.anim.durations.scale
        readonly property int expandDuration: 667 * Tokens.anim.durations.scale
        readonly property int collapseDuration: 667 * Tokens.anim.durations.scale
        readonly property int completeEndDuration: 333 * Tokens.anim.durations.scale
        ...
        readonly property list<int> expandDelay: [0, 1350, 2700, 4050].map(d => d * Tokens.anim.durations.scale)
        readonly property list<int> collapseDelay: [667, 2017, 3367, 4717].map(d => d * Tokens.anim.durations.scale)
