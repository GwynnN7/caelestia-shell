...
class ServiceConfig : public ConfigObject {
    ...
    CONFIG_GLOBAL_PROPERTY(QString, defaultPlayer, u"Tidal"_s)
    CONFIG_GLOBAL_PROPERTY(QVariantList, playerAliases, {
        ...
        vmap({ { u"from"_s, u"tidal-hifi"_s }, { u"to"_s, u"Tidal"_s } })
    })
    CONFIG_GLOBAL_PROPERTY(bool, showLyrics, true)
    CONFIG_GLOBAL_PROPERTY(QString, lyricsBackend, u"NetEase"_s)
